/**************************************************************/
// gcc -O1 -mavx test_intrinsics.c -lm -lrt -o test_intrinsics
...
int main(int argc, char *argv[])
{
  ...
  void  ArrayTest4(data_t* pA1, data_t* pA2, data_t* pR, long int nSize);
  void  ArrayTest5(data_t* pA1, data_t* pA2, data_t* pR, long int nSize);
  void  ArrayTest6(data_t* pA1, data_t* pA2, data_t* pR, long int nSize);
  ...
  for (i = 0; i < ITERS; i++) {
    clock_gettime(CLOCK_PROCESS_CPUTIME_ID, &time1);
    ArrayTest4(pArray1, pArray2, pResult, BASE+(i+1)*DELTA);
    clock_gettime(CLOCK_PROCESS_CPUTIME_ID, &time2);
    time_stamp[OPTION][i] = diff(time1,time2);
  }
  ...
  for (i = 0; i < ITERS; i++) {
    clock_gettime(CLOCK_PROCESS_CPUTIME_ID, &time1);
    ArrayTest5(pArray1, pArray2, pResult, BASE+(i+1)*DELTA);
    clock_gettime(CLOCK_PROCESS_CPUTIME_ID, &time2);
    time_stamp[OPTION][i] = diff(time1,time2);
  }
  ...
  for (i = 0; i < ITERS; i++) {
    clock_gettime(CLOCK_PROCESS_CPUTIME_ID, &time1);
    ArrayTest6(pArray1, pArray2, pResult, BASE+(i+1)*DELTA);
    clock_gettime(CLOCK_PROCESS_CPUTIME_ID, &time2);
    time_stamp[OPTION][i] = diff(time1,time2);
  }
...
//Element-wise Add
void ArrayTest4(data_t* pArray1,       // [in] 1st source array
    data_t* pArray2,       // [in] 2nd source array
    data_t* pResult,       // [out] result array
    long int nSize)            // [in] size of all arrays
{
...
void ArrayTest5(data_t* pArray1,       // [in] 1st source array
    data_t* pArray2,       // [in] 2nd source array
    data_t* pResult,       // [out] result array
    long int nSize)            // [in] size of all arrays
{
...
void ArrayTest6(data_t* pArray1,       // [in] 1st source array
    data_t* pArray2,       // [in] 2nd source array
    data_t* pResult,       // [out] result array
    long int nSize)            // [in] size of all arrays
{
